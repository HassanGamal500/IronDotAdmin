                    ...
                    <div class="table-responsive">
                        <table id="example" class="table table-bordered text-center datatable" style="width:100%">
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-danger p-3 alerts" data-url="{{url('delete_portfolio_image')}}/" data-table="datatable" data-id="{{ $image->id }}">{{trans('admin.delete')}}</button>
                                </td>
                            </tr>
                            @endforeach
                            </tbody>
    ...
    <div class="modal fade" id="image" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method="post" action="{{route('store_portfolio_image')}}" enctype="multipart/form-data">
                    @csrf
